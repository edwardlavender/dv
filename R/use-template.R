...
#' * data/ for data
#'   * inst/ for [`dv`] project-management files
...
#' proj <- file.path(tempdir(), "tmp")
#' usethis::create_project(path = proj, open = FALSE)
#' # Populate with standard 'dv' files
...
#'
#' @details This function creates a standard README as part of [`dv`]'s `use_template_*()` workflow. The README includes the following sections:
#' * Introduction
#' * Description
#'   * Dependencies
#'   * Directories
